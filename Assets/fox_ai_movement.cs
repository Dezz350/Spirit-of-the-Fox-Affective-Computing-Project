...
public class fox_ai_movement : MonoBehaviour
{
    ...
    Animator fox_anim;
    GameObject Path;
    hidden_path1 hidden_path_script;
    ...
    void Start()
    {
        ...
        Path = GameObject.Find("hidden_path_trigger");
        hidden_path_script = Path.GetComponent<hidden_path1>();
        hidden_path_script.hidden_limit = 0;
    ...
    void Update()
    {
        ...
        if (hidden_path_script.hidden_limit == 1 && hidden_path_limit == 1)
        {
            limit = 1;
            hidden_path_limit = 0;
        }
